...
<div class="main-panel">
    <div class="content bg-light">
        <div class="page-inner">
            ...
            @endif
            <div class="mt-2 mb-4">
                <h1 class="title1 text-dark">Current Exhibitions</h1>
            </div>

            <div class="row">
                <div class="col-12">
                    <a href="{{route('admin.current-exhibitions.create')}}" class="float-right btn btn-primary">
                        <i class='fas fa-plus-circle'></i> Add Current Exhibition
                    </a>
                </div>
            </div>
            <div class="mb-5 row">
