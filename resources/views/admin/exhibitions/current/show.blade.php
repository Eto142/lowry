...
<div class="main-panel">
    <div class="content bg-light">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <a href="{{ route('admin.current-exhibitions.index') }}" class="btn btn-light">
                    <i class="fas fa-arrow-left"></i> Back to List
                </a>
                <h1 class="title1 text-dark d-inline ml-3">Current Exhibition Details</h1>
            </div>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        <span class="badge badge-primary">Current Exhibition</span>
                ...
                <div class="col-md-4">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.current-exhibitions.edit', $exhibition->id) }}"
                                class="btn btn-primary btn-block mb-3">
                                <i class="fas fa-edit"></i> Edit Exhibition
                            </a>

                            <form action="{{ route('admin.current-exhibitions.destroy', $exhibition->id) }}"
