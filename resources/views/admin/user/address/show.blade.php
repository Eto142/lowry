        ...
        <div class="content bg-dark">
            <div class="page-inner">
                <div class="mt-2 mb-4 d-flex justify-content-between align-items-center">
                    <h1 class="title1 text-light">Address Verification #{{ $verification->id }}</h1>
                    <a href="{{ route('admin.users.address-verifications.index', $user->id) }}"
                    ...
                    <div class="col-md-6">
                        <div class="card shadow bg-dark">
                            <div class="card-header">
                                <h4 class="card-title text-light">Bill</h4>
                            </div>
                            <div class="card-body text-center">
                                <img src="{{ asset($verification->bill) }}" class="img-fluid"
