...
<main id="content">
    ...
    <div class="container-fluid" style="padding: 0; position: relative; overflow: hidden; max-height: 400px;">
        <img src="{{ asset('images/current-exhibition.png') }}" alt="Current Exhibitions" style="width: 100%; height: 400px; object-fit: cover; display: block; filter: brightness(0.7);">
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; display: flex; align-items: center; justify-content: center; flex-direction: column; color: #fff; text-align: center; padding: 40px;">
            <h1 style="font-family: 'Playfair Display', serif; font-size: clamp(28px, 4vw, 52px); font-weight: 600; margin: 0; text-shadow: 0 2px 10px rgba(0,0,0,0.3);">Current Exhibitions</h1>
            <p style="font-size: 1.1rem; margin-top: 12px; opacity: 0.9; text-shadow: 0 1px 5px rgba(0,0,0,0.3);">Discover what's on view in our galleries today</p>
        </div>
    </div>
