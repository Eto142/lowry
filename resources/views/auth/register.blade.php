              ...
              <div class="card-body p-4">
                <div class="row">
                  <div class="col-md-8 border-end">
                    ...
                    <form>
                      <div class="mb-3">
                        <input type="text" class="form-control name-input border-red py-1" placeholder="First Name">
                      </div>
                      
                      <div class="mb-3">
                        <input type="text" class="form-control name-input border-red py-1" placeholder="Last Name">
                      </div>
                      
                      <div class="mb-3">
                        <div class="input-group">
                          <input type="email" class="form-control border-red py-1 no-border-right" placeholder="E-mail">
                      ...
                      <div class="mb-3">
                        <div class="input-group">
                          <input type="tel" class="form-control border-red no-border-right py-1" placeholder="Home Phone">
                      ...
                      <div class="mb-4">
                        <div class="input-group">
                          <input type="text" class="form-control py-1" placeholder="Birthday">
