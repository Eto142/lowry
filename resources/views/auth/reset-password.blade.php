        ...
        <div class="card-body p-4">
          <div class="text-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="80" viewBox="0 0 200 80">
              <text x="10" y="50" font-family="Arial, sans-serif" font-size="40" font-weight="bold" fill="#333"><img
                  src="{{asset('images/logo.jpeg')}}" alt="arielle-artstudio" width="150px"></text>
            </svg>
          ...
          <form id="reset-password-form" action="{{ route('password.update') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <input type="password" name="password_confirmation" class="form-control py-2" id="password-confirm"
